...
-- --     CHECK (stipend >= 0),
-- --     CHECK (tentative_ctc >= 0),
-- --     CHECK (registration_link ~ '^https?://')
-- -- );
...
-- --     CHECK (applied_at <= CURRENT_TIMESTAMP)
-- -- );
...
-- --     CHECK (issued_at <= CURRENT_TIMESTAMP),
-- --     CHECK (reason <> '')
-- -- );
...
-- INSERT INTO Users
-- (username, email, password_hash, role_id, is_verified, full_name, contact_number, status)
-- VALUES
...
-- twelfth_percent, twelfth_passout_year)
-- VALUES
...
-- (log_id, user_id, action, ip_address, start_time, end_time, device_info)
-- VALUES
...
-- INSERT INTO Alumni_User
-- (alumni_id, user_id, grad_year, current_company, placement_history, designation)
-- VALUES
...
-- INSERT INTO Resumes
-- (resume_id, student_id, resume_label, file_url, ats_score, is_verified, uploaded_at)
-- VALUES
...
-- (1,41,'Tata Consultancy Services','IT Services','Service-Based',
-- 'Hires 50+ students annually from campus',
-- 'Leading Indian multinational IT services and consulting company',
-- 'https://www.tcs.com'),

-- (2,42,'Infosys','IT Services','Service-Based',
-- 'Hires 40+ students annually',
-- 'Global leader in next-generation digital services and consulting',
-- 'https://www.infosys.com'),

-- (3,43,'Google','Software','Product-Based',
-- 'Hires 5–10 students annually',
-- 'Global technology leader specializing in internet-related services',
-- 'https://careers.google.com'),

-- (4,44,'Microsoft','Software','Product-Based',
-- 'Hires 8–12 students annually',
-- 'Multinational technology corporation producing software and services',
-- 'https://careers.microsoft.com'),

-- (5,45,'Amazon','E-Commerce','Product-Based',
-- 'Hires 10–15 students annually',
-- 'World’s largest online retailer and cloud provider',
-- 'https://www.amazon.jobs'),

-- (6,46,'Meta','Social Media','Product-Based',
-- 'Hires 5–8 students annually',
-- 'Technology company focusing on social media and virtual reality',
-- 'https://www.metacareers.com'),

-- (7,47,'IBM','IT Services','Service-Based',
-- 'Hires 20+ students annually',
-- 'Global technology and consulting company',
-- 'https://www.ibm.com/careers'),

-- (8,48,'Oracle','Database Software','Product-Based',
-- 'Hires 10+ students annually',
-- 'Specializes in database software and enterprise solutions',
-- 'https://www.oracle.com/careers'),

-- (9,49,'Intel','Semiconductors','Product-Based',
-- 'Hires 5–10 students annually',
-- 'Designs and manufactures semiconductor chips',
-- 'https://jobs.intel.com'),

-- (10,50,'NVIDIA','Semiconductors','Product-Based',
-- 'Hires 5+ students annually',
-- 'Leader in GPU computing and AI technology',
-- 'https://www.nvidia.com/careers'),

-- (11,51,'Adobe','Software','Product-Based',
-- 'Hires 5–7 students annually',
-- 'Known for creative and multimedia software products',
-- 'https://careers.adobe.com'),

-- (12,52,'Salesforce','Cloud Computing','Product-Based',
-- 'Hires 5–10 students annually',
-- 'Cloud-based customer relationship management company',
-- 'https://careers.salesforce.com'),

-- (13,53,'Uber','Technology','Product-Based',
-- 'Hires 3–6 students annually',
-- 'Ride-hailing and technology platform company',
-- 'https://www.uber.com/careers'),

-- (14,54,'Netflix','Entertainment Technology','Product-Based',
-- 'Hires 2–5 students annually',
-- 'Streaming entertainment and production company',
-- 'https://jobs.netflix.com'),

-- (15,55,'Accenture','IT Services','Service-Based',
-- 'Hires 30+ students annually',
...
--  'Bangalore', 1200000, 'Full-Time', '2025-01-01', '2025-02-01'),

-- (2, 2, 'Data Analyst',
--  'Analyze business data and generate insights',
--  'Mumbai', 800000, 'Full-Time', '2025-01-05', '2025-02-05'),

-- (3, 3, 'Backend Developer',
--  'Build scalable backend APIs',
--  'Hyderabad', 1100000, 'Full-Time', '2025-01-10', '2025-02-10'),

-- (4, 4, , 'Frontend Developer',
--  'Create responsive user interfaces',
--  'Pune', 900000, 'Full-Time', '2025-01-12', '2025-02-12'),

-- (5, 5, 45, 'DevOps Engineer',
--  'Manage CI/CD pipelines and deployment',
--  'Chennai', 1300000, 'Full-Time', '2025-01-15', '2025-02-15'),

-- (6, 6, 46, 'AI Engineer',
--  'Develop machine learning models',
--  'Bangalore', 1500000, 'Full-Time', '2025-01-18', '2025-02-18'),

-- (7, 7, 47, 'Cloud Engineer',
--  'Manage cloud infrastructure',
--  'Hyderabad', 1400000, 'Full-Time', '2025-01-20', '2025-02-20'),

-- (8, 8, 48, 'Cyber Security Analyst',
--  'Ensure system security',
--  'Mumbai', 1000000, 'Full-Time', '2025-01-22', '2025-02-22'),

-- (9, 9, 49, 'Full Stack Developer',
--  'Work on frontend and backend',
--  'Pune', 1250000, 'Full-Time', '2025-01-25', '2025-02-25'),

-- (10, 10, 50, 'Mobile App Developer',
--  'Develop Android applications',
--  'Chennai', 950000, 'Full-Time', '2025-01-28', '2025-02-28'),

-- (11, 11, 51, 'QA Engineer',
--  'Test applications and ensure quality',
--  'Noida', 700000, 'Full-Time', '2025-02-01', '2025-03-01'),

-- (12, 12, 52, 'Business Analyst',
--  'Gather requirements and analyze',
--  'Gurgaon', 850000, 'Full-Time', '2025-02-05', '2025-03-05'),

-- (13, 13, 53, 'System Engineer',
--  'Maintain IT systems',
--  'Ahmedabad', 750000, 'Full-Time', '2025-02-08', '2025-03-08'),

-- (14, 14, 54, 'Database Administrator',
--  'Manage database systems',
--  'Bangalore', 1150000, 'Full-Time', '2025-02-10', '2025-03-10'),

-- (15, 15, 55, 'Machine Learning Engineer',
--  'Build ML pipelines',
--  'Hyderabad', 1600000, 'Full-Time', '2025-02-12', '2025-03-12');
...
-- (2, 2, 1, '2025-01-06', 'Shortlisted'),
-- (3, 3, 2, '2025-01-07', 'Applied'),
-- (4, 4, 2, '2025-01-08', 'Rejected'),
-- (5, 5, 3, '2025-01-09', 'Shortlisted'),
-- (6, 6, 3, '2025-01-10', 'Applied'),
-- (7, 7, 4, '2025-01-11', 'Applied'),
-- (8, 8, 4, '2025-01-12', 'Shortlisted'),
-- (9, 9, 5, '2025-01-13', 'Rejected'),
-- (10, 10, 5, '2025-01-14', 'Applied'),

-- (11, 11, 6, '2025-01-15', 'Shortlisted'),
-- (12, 12, 6, '2025-01-16', 'Applied'),
-- (13, 13, 7, '2025-01-17', 'Rejected'),
-- (14, 14, 7, '2025-01-18', 'Applied'),
-- (15, 15, 8, '2025-01-19', 'Shortlisted'),
-- (16, 16, 8, '2025-01-20', 'Applied'),
-- (17, 17, 9, '2025-01-21', 'Applied'),
-- (18, 18, 9, '2025-01-22', 'Rejected'),
-- (19, 19, 10, '2025-01-23', 'Shortlisted'),
-- (20, 20, 10, '2025-01-24', 'Applied'),

-- (21, 21, 11, '2025-01-25', 'Applied'),
-- (22, 22, 11, '2025-01-26', 'Shortlisted'),
-- (23, 23, 12, '2025-01-27', 'Applied'),
-- (24, 24, 12, '2025-01-28', 'Rejected'),
-- (25, 25, 13, '2025-01-29', 'Shortlisted'),
-- (26, 26, 13, '2025-01-30', 'Applied'),
-- (27, 27, 14, '2025-02-01', 'Applied'),
-- (28, 28, 14, '2025-02-02', 'Shortlisted'),
-- (29, 29, 15, '2025-02-03', 'Applied'),
-- (30, 30, 15, '2025-02-04', 'Shortlisted'),

-- (31, 1, 6, '2025-02-05', 'Applied'),
-- (32, 2, 7, '2025-02-06', 'Applied'),
-- (33, 3, 8, '2025-02-07', 'Rejected'),
-- (34, 4, 9, '2025-02-08', 'Applied'),
-- (35, 5, 10, '2025-02-09', 'Shortlisted');

-- INSERT INTO job_events VALUES
-- (1, 1, 'Infosys Pre-Placement Talk', '2025-01-03', '10:00', 'Auditorium A',
--  'Company presentation and hiring process explanation'),

-- (2, 2, 'TCS Online Test', '2025-01-08', '09:00', 'Computer Lab 1',
--  'Aptitude and technical online assessment'),

-- (3, 3, 'Wipro Technical Test', '2025-01-12', '10:00', 'Computer Lab 2',
--  'Technical written test'),

-- (4, 4, 'Accenture PPT', '2025-01-15', '11:00', 'Seminar Hall',
--  'Pre-placement talk'),

-- (5, 5, 'Capgemini Coding Test', '2025-01-18', '09:30', 'Lab 3',
--  'Online coding round'),

-- (6, 6, 'Google Technical Interview', '2025-01-20', '10:00', 'Placement Office',
--  'Technical interview round'),

-- (7, 7, 'Microsoft Interview', '2025-01-22', '11:00', 'Placement Office',
--  'Technical and HR interview'),

-- (8, 8, 'Amazon Assessment', '2025-01-24', '09:00', 'Lab 4',
--  'Online assessment'),

-- (9, 9, 'IBM Interview', '2025-01-26', '10:30', 'Placement Office',
--  'Technical interview'),

-- (10, 10, 'Cognizant PPT', '2025-01-28', '12:00', 'Seminar Hall',
--  'Company overview'),

-- (11, 11, 'Oracle Interview', '2025-02-02', '10:00', 'Placement Office',
--  'Interview round'),

-- (12, 12, 'Deloitte Test', '2025-02-04', '09:00', 'Lab 5',
--  'Online test'),

-- (13, 13, 'HCL Interview', '2025-02-06', '11:30', 'Placement Office',
--  'Technical interview'),

-- (14, 14, 'Tech Mahindra Test', '2025-02-08', '09:30', 'Lab 2',
--  'Online test'),

-- (15, 15, 'Zoho Interview', '2025-02-10', '10:00', 'Placement Office',
--  'Final interview');
...
-- INSERT INTO venue_booking VALUES
...
-- (1, 1, 6,
-- 'https://meet.google.com/inf-interview-001',
-- 'Google Meet'),

-- (2, 2, 7,
-- 'https://teams.microsoft.com/interview-002',
-- 'Microsoft Teams'),

-- (3, 3, 9,
-- 'https://zoom.us/interview-003',
-- 'Zoom'),

-- (4, 4, 11,
-- 'https://meet.google.com/interview-004',
-- 'Google Meet'),

-- (5, 5, 13,
-- 'https://teams.microsoft.com/interview-005',
-- 'Microsoft Teams'),

-- (6, 6, 15,
-- 'https://zoom.us/interview-006',
-- 'Zoom'),

-- (7, 7, 6,
-- 'https://meet.google.com/interview-007',
-- 'Google Meet'),

-- (8, 8, 7,
-- 'https://teams.microsoft.com/interview-008',
-- 'Microsoft Teams'),

-- (9, 9, 9,
-- 'https://zoom.us/interview-009',
-- 'Zoom'),

-- (10, 10, 11,
-- 'https://meet.google.com/interview-010',
-- 'Google Meet'),

-- (11, 11, 13,
-- 'https://teams.microsoft.com/interview-011',
-- 'Microsoft Teams'),

-- (12, 12, 15,
-- 'https://zoom.us/interview-012',
-- 'Zoom'),

-- (13, 13, 6,
-- 'https://meet.google.com/interview-013',
-- 'Google Meet'),

-- (14, 14, 7,
-- 'https://teams.microsoft.com/interview-014',
-- 'Microsoft Teams'),

-- (15, 15, 9,
-- 'https://zoom.us/interview-015',
-- 'Zoom');
...
-- (4, 4,
-- 'Find the time complexity of binary search.',
-- 'MCQ',
-- 'Easy',
-- 4),
...
-- (7, 7,
-- 'Write a program to detect cycle in graph.',
-- 'Coding',
-- 'Hard',
-- 7),
...
-- (11, 11,
-- 'Write query to join three tables.',
-- 'Coding',
-- 'Hard',
-- 1),
...
-- INSERT INTO prep_pages VALUES

-- (1, 1,
-- 'Infosys process includes aptitude test, technical interview and HR round.',
-- 'Focus on aptitude and DBMS concepts. HR is easy if confident.'),

-- (2, 2,
-- 'TCS process includes online test, technical and managerial interview.',
-- 'Coding basics and communication skills are important.'),

-- (3, 3,
-- 'Wipro has aptitude, technical interview and HR.',
-- 'Prepare OOPS and basic programming questions.'),

-- (4, 4,
-- 'Accenture process includes aptitude, coding and interview.',
-- 'Practice coding on arrays and strings.'),

-- (5, 5,
-- 'Capgemini focuses on aptitude and coding test.',
-- 'SQL and logical reasoning questions are common.'),

-- (6, 6,
-- 'Google process includes coding rounds and system design.',
-- 'Practice DSA and system design extensively.'),

-- (7, 7,
-- 'Microsoft includes online coding test and interviews.',
-- 'Focus on problem solving and data structures.'),

-- (8, 8,
-- 'Amazon process includes OA and technical interviews.',
-- 'Practice Leetcode medium and hard questions.'),

-- (9, 9,
-- 'IBM process includes aptitude and technical interview.',
-- 'Focus on DBMS and basic programming.'),

-- (10, 10,
-- 'Cognizant includes aptitude and technical interview.',
-- 'Coding and aptitude both are important.'),

-- (11, 11,
-- 'Oracle includes coding and system design interview.',
-- 'SQL and DBMS questions are frequently asked.'),

-- (12, 12,
-- 'Deloitte includes aptitude and technical rounds.',
-- 'Prepare aptitude and communication skills.'),

-- (13, 13,
-- 'HCL includes aptitude and technical interview.',
-- 'Focus on core subjects and confidence.'),

-- (14, 14,
-- 'Tech Mahindra includes aptitude and HR round.',
-- 'Communication skills matter most.'),

-- (15, 15,
-- 'Zoho includes coding rounds and interviews.',
-- 'Strong DSA preparation is required.');




-- INSERT INTO placement_stats VALUES
...
-- (1, 101,
-- 'Absent during Infosys interview without notice',
-- 'Warning',
-- '2025-01-05'),

-- (2, 102,
-- 'Late arrival in TCS online test',
-- 'Warning',
-- '2025-01-08'),

-- (3, 103,
-- 'No show for Wipro interview',
-- 'Debarment',
-- '2025-01-12'),

-- (4, 104,
-- 'Missed Accenture interview slot',
-- 'Warning',
-- '2025-01-15'),

-- (5, 105,
-- 'Did not attend Capgemini test after registration',
-- 'Debarment',
-- '2025-01-18'),

-- (6, 106,
-- 'Misconduct during Google interview',
-- 'Debarment',
-- '2025-01-20'),

-- (7, 107,
-- 'Late submission of placement documents',
-- 'Warning',
-- '2025-01-22'),

-- (8, 108,
-- 'Absent in Amazon interview',
-- 'Debarment',
-- '2025-01-24'),

-- (9, 109,
-- 'Violation of placement rules',
-- 'Warning',
-- '2025-01-26'),

-- (10, 110,
-- 'No show in Cognizant interview',
-- 'Debarment',
-- '2025-01-28'),

-- (11, 111,
-- 'Improper behavior during interview',
-- 'Warning',
-- '2025-02-02'),

-- (12, 112,
-- 'Missed Deloitte interview',
-- 'Debarment',
-- '2025-02-04'),

-- (13, 113,
-- 'Absent in HCL recruitment process',
-- 'Warning',
-- '2025-02-06'),

-- (14, 114,
-- 'Failed to attend Tech Mahindra interview',
-- 'Debarment',
-- '2025-02-08'),

-- (15, 115,
-- 'No show in Zoho interview',
-- 'Debarment',
-- '2025-02-10');
...
-- INSERT INTO cds_training_sessions VALUES

-- (1,
-- 'Resume Building Workshop',
-- 'Session on creating ATS friendly resumes',
-- '2025-01-02 10:00:00',
-- '2025-01-02 12:00:00',
-- 'OFFLINE',
-- '2024-12-20 09:00:00'),
...
-- 'Training on quantitative aptitude and logical reasoning',
-- '2025-01-05 14:00:00',
-- '2025-01-05 16:00:00',
-- 'ONLINE',
-- '2024-12-22 10:00:00'),
...
-- 'Guidance on clearing technical interviews',
-- '2025-01-08 10:00:00',
-- '2025-01-08 12:30:00',
-- 'OFFLINE',
-- '2024-12-24 11:00:00'),
...
-- 'DSA and coding interview guidance',
-- '2025-01-15 10:00:00',
-- '2025-01-15 13:00:00',
-- 'ONLINE',
-- '2024-12-30 12:00:00'),
...
-- 'Training for HR interview questions',
-- '2025-01-18 11:00:00',
-- '2025-01-18 13:00:00',
-- 'OFFLINE',
-- '2025-01-01 10:00:00'),
...
-- 'Improve LinkedIn profile for recruiters',
-- '2025-01-22 10:00:00',
-- '2025-01-22 12:00:00',
-- 'ONLINE',
-- '2025-01-05 09:00:00'),
...
-- 'Practice competitive programming questions',
-- '2025-01-26 14:00:00',
-- '2025-01-26 17:00:00',
-- 'ONLINE',
-- '2025-01-09 11:30:00'),
...
-- 'Alumni sharing interview experiences',
-- '2025-01-28 10:00:00',
-- '2025-01-28 13:00:00',
-- 'OFFLINE',
-- '2025-01-11 09:00:00'),
...
-- (13,
-- 'Placement Strategy Session',
-- 'Planning placement preparation strategy',
-- '2025-01-30 11:00:00',
-- '2025-01-30 13:00:00',
-- 'ONLINE',
-- '2025-01-13 10:00:00'),
...
-- 'Last minute placement preparation tips',
-- '2025-02-05 14:00:00',
-- '2025-02-05 16:30:00',
-- 'ONLINE',
-- '2025-01-17 11:00:00');
